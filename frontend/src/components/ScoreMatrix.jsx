  ...
  return (
    <div className="heatmap-container">
      <div className="section-header" style={{ marginBottom: '8px' }}>
        <span className="section-title" style={{ fontSize: '1rem' }}>比分概率分布图 (Heatmap)</span>
        {hoveredCell ? (
          <span className="section-subtitle" style={{ color: 'var(--accent)', fontFamily: 'var(--font-mono)' }}>
            ...
            <strong style={{ color: 'white' }}>{hoveredCell.prob}%</strong> ({hoveredCell.outcome})
          </span>
        ) : (
          <span className="section-subtitle">将鼠标悬停在单元格上以查看详细概率</span>
        )}
      </div>
      ...
      <div className="heatmap-scroll-wrapper">
        <div className="heatmap-grid-layout">
          ...
          <div className="heatmap-label-cell corner">
            <span style={{ fontSize: '0.55rem', alignSelf: 'flex-end', paddingRight: '2px' }}>客 &rarr;</span>
            <span style={{ fontSize: '0.55rem', alignSelf: 'flex-start', paddingLeft: '2px' }}>&darr; 主</span>
          </div>
